      ...
      <div className="min-h-screen bg-background pb-20 md:pb-6">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Financial Structure */}
            <BlurFade delay={0.1}>
              <Card className="h-full relative overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm group hover:border-green-500/50 transition-colors">
                <CardHeader>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {Object.values(TEAM_MEMBERS).map((member) => (
                      <Badge key={member} variant="secondary" className="px-3 High py-1 text-xs">
                        {member}
                      </Badge>
                    ))}
                  </div>
